...
var _router = require("./router"); // Importa el enrutador desde tu archivo router.js
...
var _indexJs = require("./router/index.js"); // Importar el enrutador desde el archivo index.js
exports.default = {
    name: "App",
    components: {
...
const _hoisted_2 = /*#__PURE__*/ (0, _vue.createStaticVNode)('<figure class="logo"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/League_of_Legends_2019_vector.svg/800px-League_of_Legends_2019_vector.svg.png" alt="Logo"></figure><section class="sponsor-group"><span class="sponsor-thanks">Gracias por patrocinarnos</span><a class="sponsor-image"></a></section>', 2);
    ...
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("header", _hoisted_1, [
        ...
        (0, _vue.createElementVNode)("nav", {
            ...
            (0, _vue.createVNode)(_component_router_link, {
                ...
                default: (0, _vue.withCtx)(()=>[
                        (0, _vue.createTextVNode)("Equipos")
                    ]),
                _: 1 /* STABLE */ 
            }),
            (0, _vue.createVNode)(_component_router_link, {
                ...
                default: (0, _vue.withCtx)(()=>[
                        (0, _vue.createTextVNode)("Partidas")
                    ]),
                _: 1 /* STABLE */ 
            })
        ], 2 /* CLASS */ )
...
const _hoisted_4 = /*#__PURE__*/ (0, _vue.createStaticVNode)('<section class="info-section"><div class="copyright"><p> \xa9 2023 Todos los derechos reservados. </p><p><a href="#">Condiciones de uso</a></p><p><a href="#">Politica de cookies</a></p></div><div class="social-icons"><a href="#" class="social-icon"><i class="fab fa-instagram"></i></a><a href="#" class="social-icon"><i class="fab fa-twitter"></i></a><a href="#" class="social-icon"><i class="fab fa-facebook"></i></a><a href="#" class="social-icon"><i class="fab fa-youtube"></i></a><a href="#" class="social-icon"><i class="fab fa-twitch"></i></a></div></section>', 1);
    ...
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("footer", _hoisted_1, [
        (0, _vue.createElementVNode)("section", _hoisted_2, [
            (0, _vue.createElementVNode)("div", _hoisted_3, [
                ((0, _vue.openBlock)(), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)(15, (number)=>{
                    return (0, _vue.createElementVNode)("a", {
                        key: number,
                        class: (0, _vue.normalizeClass)("sponsor-image sponsor-" + number)
                    }, null, 2 /* CLASS */ );
                }), 64 /* STABLE_FRAGMENT */ ))
            ])
        ]),
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lY5uy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vueRouter = require("vue-router");
var _homeVue = require("../pages/Home.vue");
var _homeVueDefault = parcelHelpers.interopDefault(_homeVue);
var _teamsVue = require("../pages/Teams.vue");
var _teamsVueDefault = parcelHelpers.interopDefault(_teamsVue);
var _notFoundVue = require("../pages/NotFound.vue");
var _notFoundVueDefault = parcelHelpers.interopDefault(_notFoundVue);
var _matchesVue = require("../pages/Matches.vue");
var _matchesVueDefault = parcelHelpers.interopDefault(_matchesVue);
var _playersVue = require("../components/Players.vue");
var _playersVueDefault = parcelHelpers.interopDefault(_playersVue);
const routes = [
    {
        path: "/",
        name: "Home",
    ...
    },
    {
        path: "/teams",
        name: "Teams",
        component: (0, _teamsVueDefault.default)
    },
    {
        path: "/teams/:team",
        name: "Players",
        component: (0, _playersVueDefault.default),
        props: true // Asegúrate de agregar esta línea para pasar props desde la ruta
    },
    {
        path: "/matches",
        name: "Matches",
        component: (0, _matchesVueDefault.default)
    },
 ...
 */ function createRouter(options) {
    ...
    function triggerAfterEach(to, from, failure) {
        ...
        for (const guard of afterGuards.list())runWithContext(()=>guard(to, from, failure));
    }
    /**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gHxj8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jwsc2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
...
const _hoisted_2 = /*#__PURE__*/ (0, _vue.createElementVNode)("h1", {
    class: "team-heading"
}, "EQUIPOS", -1 /* HOISTED */ );
const _hoisted_3 = {
    class: "team-images"
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        ...
        (0, _vue.createElementVNode)("section", _hoisted_3, [
            ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($data.imagePaths, (imagePath)=>{
                return (0, _vue.openBlock)(), (0, _vue.createBlock)(_component_router_link, {
                    to: `/teams/${imagePath.name}`,
                    key: imagePath.src
                }, {
                    default: (0, _vue.withCtx)(()=>[
                            (0, _vue.createElementVNode)("figure", _hoisted_4, [
                                (0, _vue.createElementVNode)("img", {
                                    src: imagePath.src,
                                    alt: imagePath.name,
                                    class: "team-image"
                                }, null, 8 /* PROPS */ , _hoisted_5),
                                (0, _vue.createElementVNode)("figcaption", _hoisted_6, (0, _vue.toDisplayString)(imagePath.name), 1 /* TEXT */ )
                            ])
                        ]),
                    _: 2 /* DYNAMIC */ 
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hRhsr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
const _hoisted_2 = /*#__PURE__*/ (0, _vue.createElementVNode)("h1", null, "Error 404: P\xe1gina no encontrada", -1 /* HOISTED */ );
const _hoisted_3 = /*#__PURE__*/ (0, _vue.createElementVNode)("p", null, "Lo sentimos, la p\xe1gina que est\xe1s buscando no existe.", -1 /* HOISTED */ );
const _hoisted_4 = [
    _hoisted_2,
    _hoisted_3
];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hyacB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lzGa0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        (0, _vue.createElementVNode)("ul", _hoisted_2, [
            ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($data.matches, (match)=>{
                return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("li", {
                    ...
                    (0, _vue.createElementVNode)("section", _hoisted_3, [
                        ...
                        (0, _vue.createElementVNode)("figure", _hoisted_5, [
                            ...
                            (0, _vue.createElementVNode)("p", _hoisted_7, (0, _vue.toDisplayString)(match.team1.name), 1 /* TEXT */ ),
                            (0, _vue.createElementVNode)("p", {
                                class: (0, _vue.normalizeClass)([
                                    "result",
                                    {
                                        "victory": match.winner === match.team1.name,
                                        "defeat": match.winner === match.team2.name,
                                        "draw": match.winner === "Empate"
                                    }
                                ])
                            }, (0, _vue.toDisplayString)(match.winner === match.team1.name ? "Victoria" : match.winner === "Empate" ? "Empate" : "Derrota"), 3 /* TEXT, CLASS */ )
                        ]),
                        (0, _vue.createElementVNode)("figure", _hoisted_8, [
                            (0, _vue.createElementVNode)("img", {
                                src: match.team2.src,
                                alt: match.team2.name,
                                class: "team-logo"
                            }, null, 8 /* PROPS */ , _hoisted_9),
                            (0, _vue.createElementVNode)("p", _hoisted_10, (0, _vue.toDisplayString)(match.team2.name), 1 /* TEXT */ ),
                            (0, _vue.createElementVNode)("p", {
                                class: (0, _vue.normalizeClass)([
                                    "result",
                                    {
                                        "victory": match.winner === match.team2.name,
                                        "defeat": match.winner === match.team1.name,
                                        "draw": match.winner === "Empate"
                                    }
                                ])
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hg64p":[function() {},{}],"8OILE":[function() {},{}]},["e11Rl","gLLPy"], "gLLPy", "parcelRequire0d62")
